...
import resources.variables as w
...
addresses = [(w.ADDRESS_GUAVA, w.PRIVATE_KEY_GUAVA), (w.ADDRESS_GINGER, w.PRIVATE_KEY_GINGER), (w.ADDRESS_MERCURY, w.PRIVATE_KEY_MERCURY),
             (w.ADDRESS_VENUS, w.PRIVATE_KEY_VENUS), (w.ADDRESS_MARS, w.PRIVATE_KEY_MARS), (w.ADDRESS_JUPITER, w.PRIVATE_KEY_JUPITER),
             (w.ADDRESS_SATURN, w.PRIVATE_KEY_SATURN), (w.ADDRESS_URANUS, w.PRIVATE_KEY_URANUS), (w.ADDRESS_NEPTUNE, w.PRIVATE_KEY_NEPTUNE),
             (w.ADDRESS_SIRIUS, w.PRIVATE_KEY_SIRIUS), (w.ADDRESS_POLARIS, w.PRIVATE_KEY_POLARIS), (w.ADDRESS_ANTARES, w.PRIVATE_KEY_ANTARES),
             (w.ADDRESS_LIBRA, w.PRIVATE_KEY_LIBRA), (w.ADDRESS_AQUARIUS, w.PRIVATE_KEY_AQUARIUS), (w.ADDRESS_WOLF, w.PRIVATE_KEY_WOLF),
             (w.ADDRESS_FOX, w.PRIVATE_KEY_FOX), (w.ADDRESS_DEER, w.PRIVATE_KEY_DEER), (w.ADDRESS_BEAVER, w.PRIVATE_KEY_BEAVER),
             (w.ADDRESS_EAGLE, w.PRIVATE_KEY_EAGLE), (w.ADDRESS_SPARROW, w.PRIVATE_KEY_SPARROW), (w.ADDRESS_CROW, w.PRIVATE_KEY_CROW),
             (w.ADDRESS_RABBIT, w.PRIVATE_KEY_RABBIT), (w.ADDRESS_TURTLE, w.PRIVATE_KEY_TURTLE)]
